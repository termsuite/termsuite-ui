 ...
 * </p>
 * <ul>
 *   <li>{@link fr.univnantes.termsuite.ui.model.termsuiteui.impl.EResourceImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EResourceImpl extends MinimalEObjectImpl.Container implements EResource {
	...
	protected EClass eStaticClass() {
		return TermsuiteuiPackage.Literals.ERESOURCE;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TermsuiteuiPackage.ERESOURCE__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TermsuiteuiPackage.ERESOURCE__ID:
				return getId();
		}
