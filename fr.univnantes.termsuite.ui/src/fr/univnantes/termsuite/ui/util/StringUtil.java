...
public class StringUtil {
	...
	public static final String noLinebreak(String str) {
		return str.replaceAll("[\r\n\\s]+", " ");
	}

	public static Comparator<String> numberAwareComparator() {
		return new NumberAwareStringComparator();
	}
	
	private static class NumberAwareStringComparator implements Comparator<String> {
